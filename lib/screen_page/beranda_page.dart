...
import 'package:lat_audio/Model/audio_model.dart';
...
class _PageHomeState extends State<PageHome> {
  ...
  Future<ModelAudio> fetchAudio() async {
    final response = await http.get(Uri.parse('http://192.168.43.72/lat_audio/audio.php'));
          ...
          ListView.builder(
            ...
            itemBuilder: (context, index) {
              return Padding(
                ...
                child: ListTile(
                  leading: Image.network('http://192.168.43.72/lat_audio/gambar/${filteredData[index].gambar}'),
                  title: Text(
                  ...
                  trailing: Row(
                    ...
                    children: [
                      IconButton(
                        ...
                        onPressed: () {
                          playAudio(filteredData[index].id, 'http://192.168.43.72/lat_audio/audio//${filteredData[index].fileAudio}');
                        },
                      ),
                      IconButton(
                        icon: Icon(
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              image: DecorationImage(
                image: NetworkImage('http://192.168.43.72/lat_audio/gambar/${album.gambar}'),
                fit: BoxFit.cover,
              ),
            ),
          ),
